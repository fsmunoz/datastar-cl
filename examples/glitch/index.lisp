     ...
     (:html :lang "en"
      ...
      (:body :data-signals "{glitch: {active: false}, sid: ''}"
       ...
       (:div :class "terminal"
             ...
             (:h1 (:a :href "https://lambda-combine.net"
        ...
        (:p :class "prompt"
            ...
            (:span :class "cursor"))
        (:p :class "meta" (:span :id "server-stats")))))))
...
(defun render-index ()
  (with-page (:route "index")
    ...
    (:p :class "projects.list" "Would you like to know more? " (:a :href "https://lambda-combine.net/hyper-guide" "Hypermedia with Datastar and Common Lisp"))
    ))
